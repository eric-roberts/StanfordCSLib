...
/* Section 1 -- Define new "primitive" types and constants */

/*
 * Constant: null
 * --------------
 * This constant is equivalent to the uppercase <code>NULL</code> and is
 * defined for greater compatability with Java.
 */
